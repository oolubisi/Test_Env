...
import {
  saveSnagPhotosLocally,
  getSnagPhotosLocally,
  deleteSnagPhotosLocally,
} from "./db.js";
...
export async function openModal(type, editData = null) {
  ...
  if (type === "project") {
    ...
    body.innerHTML = `
      ...
      <label ${labelStyle}>Contract Subtotal</label>
      <input
        id="p_contract_subtotal"
        type="number"
        step="0.01"
        value="${escapeAttr(isEdit ? editData.contractSubtotal : "")}"
        ${largeInput}
      >
