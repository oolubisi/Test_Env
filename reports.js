...
function renderWorkOrderReport(project, workorders, vendors, settings) {
  ...
  return wrapReportPage(`${generateReportHeader("Work Orders Report", project)}
