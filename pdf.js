  ...
  return `
    <div style="border-top: 2px solid #000; margin-top: 25px; padding-top: 10px; page-break-inside: avoid;">
      <table style="width:100%; border-collapse:collapse; border:none; font-size:8px; color:#555;">
        <tr style="border:none;">
          <td style="border:none; width:33%; padding:0; vertical-align:top;"><strong style="font-size:9px; color:#000;">${escapeHtml(appSettings.estateName || "Facility Pro")}</strong><br><span style="color:#777;">${escapeHtml(appSettings.estateAddress || "")}</span></td>
          <td style="border:none; width:33%; padding:0; vertical-align:top; text-align:center;"><span style="font-size:8px; color:#888;">Page</span></td>
          <td style="border:none; width:33%; padding:0; vertical-align:top; text-align:right;"><span style="font-size:8px; color:#888;">&copy; ${year} ${escapeHtml(appSettings.fmName || "Facility Management")}. Confidential.</span></td>
        </tr>
      </table>
